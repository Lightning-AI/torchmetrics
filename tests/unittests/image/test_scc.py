...
def _reference_scc(preds, target, hp_filter, window_size, reduction):
...
def _reference_scc_simple(preds, target):
    """Reference implementation of SCC from sewar."""
    hp_filter = np.array([[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]])
    return _reference_scc(preds, target, hp_filter, window_size=8, reduction="mean")
...
class TestSpatialCorrelationCoefficient(MetricTester):
    ...
    def test_scc(self, preds, target, ddp):
        ...
        self.run_class_metric_test(
            ddp, preds, target, metric_class=SpatialCorrelationCoefficient, reference_metric=_reference_scc_simple
        )
    ...
    def test_scc_functional(self, preds, target, hp_filter, window_size, reduction):
        ...
        self.run_functional_metric_test(
            ...
            reference_metric=partial(_reference_scc, hp_filter=hp_filter, window_size=window_size, reduction=reduction),
            metric_args={
                "hp_filter": hp_filter,
