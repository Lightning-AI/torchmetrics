...
@pytest.mark.parametrize("block_size", [0, -1, -5, 1.5, "foo"])
def test_error_on_invalid_block_size(block_size):
    """Test that non-positive or non-integer block_size raises ValueError."""
