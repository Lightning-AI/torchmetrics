...
class TestBinaryAccuracy(MetricTester):
    ...
    @pytest.mark.parametrize("input_format", ["probs", "logits", "labels"])
    def test_binary_accuracy_differentiability(self, inputs, input_format, request):
    ...
    def test_binary_accuracy_half_cpu(self, inputs, dtype, input_format, request):
    ...
    @pytest.mark.parametrize("dtype", [torch.half, torch.double])
    @pytest.mark.parametrize("input_format", ["probs", "logits", "labels"])
    def test_binary_accuracy_half_gpu(self, inputs, dtype, input_format, request):
