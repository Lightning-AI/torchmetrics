...
class TestBinaryHammingDistance(MetricTester):
    ...
    def test_binary_hamming_distance(self, ddp, inputs, ignore_index, multidim_average, request):
    ...
    @pytest.mark.parametrize("ignore_index", [None, -1])
    @pytest.mark.parametrize("multidim_average", ["global", "samplewise"])
    def test_binary_hamming_distance_functional(self, inputs, ignore_index, multidim_average, request):
    ...
    def test_binary_hamming_distance_differentiability(self, inputs, request):
    ...
    def test_binary_hamming_distance_dtype_cpu(self, inputs, dtype, request):
    ...
    @pytest.mark.parametrize("dtype", [torch.half, torch.double])
    def test_binary_hamming_distance_dtype_gpu(self, inputs, dtype, request):
