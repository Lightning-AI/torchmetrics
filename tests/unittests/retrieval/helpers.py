...
_errors_test_functional_metric_parameters_k = {
    "argnames": "preds,target,message,metric_args",
    "argvalues": [
        (_irs.preds, _irs.target, "Argument ``top_k`` has to be a positive integer or None, but got -10", {"top_k": -10}),
        (_irs.preds, _irs.target, "Argument ``top_k`` has to be a positive integer or None, but got 4.0", {"top_k": 4.0}),
    ],
}
...
_errors_test_class_metric_parameters_k = {
    "argnames": "indexes,preds,target,message,metric_args",
    "argvalues": [
        (_irs.index, _irs.preds, _irs.target, "Argument ``top_k`` has to be a positive integer or None, but got -10", {"top_k": -10}),
        (_irs.index, _irs.preds, _irs.target, "Argument ``top_k`` has to be a positive integer or None, but got 4.0", {"top_k": 4.0}),
    ],
}
