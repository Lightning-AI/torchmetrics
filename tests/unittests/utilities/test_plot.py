...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            partial(MulticlassSensitivityAtSpecificity, min_specificity=0.5),
            _multiclass_randn_input,
            _multiclass_randint_input,
            id="multiclass sensitivity at specificity",
        ),
        pytest.param(
            partial(MulticlassSpecificityAtSensitivity, min_sensitivity=0.5),
            _multiclass_randn_input,
            _multiclass_randint_input,
            id="multiclass specificity at sensitivity",
        ),
        pytest.param(
            partial(MultilabelSensitivityAtSpecificity, min_specificity=0.5),
            _multilabel_rand_input,
            _multilabel_randint_input,
            id="multilabel sensitivity at specificity",
        ),
        pytest.param(
            partial(MultilabelSpecificityAtSensitivity, min_sensitivity=0.5),
            _multilabel_rand_input,
            _multilabel_randint_input,
