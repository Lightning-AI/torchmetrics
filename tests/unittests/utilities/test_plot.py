...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            partial(BinarySensitivityAtSpecificity, min_specificity=0.5),
            _rand_input,
            _binary_randint_input,
            id="binary sensitivity at specificity",
        ),
        pytest.param(
            partial(BinarySpecificityAtSensitivity, min_sensitivity=0.5),
            _rand_input,
            _binary_randint_input,
            id="binary specificity at sensitivity",
        ),
        pytest.param(
            partial(MulticlassSensitivityAtSpecificity, num_classes=3, min_specificity=0.5),
            _multiclass_randn_input,
            _multiclass_randint_input,
            id="multiclass sensitivity at specificity",
        ),
        pytest.param(
            partial(MulticlassSpecificityAtSensitivity, num_classes=3, min_sensitivity=0.5),
            _multiclass_randn_input,
            _multiclass_randint_input,
            id="multiclass specificity at sensitivity",
        ),
        pytest.param(
            partial(MultilabelSensitivityAtSpecificity, num_labels=3, min_specificity=0.5),
            _multilabel_rand_input,
            _multilabel_randint_input,
            id="multilabel sensitivity at specificity",
        ),
        pytest.param(
            partial(MultilabelSpecificityAtSensitivity, num_labels=3, min_sensitivity=0.5),
            _multilabel_rand_input,
            _multilabel_randint_input,
            id="multilabel specificity at sensitivity",
        ),
        pytest.param(
