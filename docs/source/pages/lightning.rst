...
.. note::
    ...
    tensors (often dicts or list of tensors) and should therefore be dealt with seperately. For info about the return type and shape please look at the documentation for
