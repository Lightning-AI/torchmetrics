...
class BinaryPrecision(BinaryStatScores):
    ...
    Example (multidim tensors):
        ...
        ...     ]
        ... )
        >>> bp = BinaryPrecision(multidim_average='samplewise')
        >>> bp(preds, target)
...
class MultilabelPrecision(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> target = torch.tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = torch.tensor([[0, 0, 1], [1, 0, 1]])
        >>> mlp = MultilabelPrecision(num_labels=3)
        >>> mlp(preds, target)
        tensor(0.5000)
...
class BinaryRecall(BinaryStatScores):
    ...
    Example (multidim tensors):
        ...
        ...     ]
        ... )
        >>> br = BinaryRecall(multidim_average='samplewise')
        >>> br(preds, target)
...
class MulticlassRecall(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> target = torch.tensor([2, 1, 0, 0])
        >>> preds = torch.tensor([2, 1, 0, 1])
        >>> mcr = MulticlassRecall(num_classes=3)
        >>> mcr(preds, target)
        tensor(0.8333)
...
class MultilabelRecall(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> target = torch.tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = torch.tensor([[0, 0, 1], [1, 0, 1]])
        >>> mlr = MultilabelRecall(num_labels=3)
        >>> mlr(preds, target)
        tensor(0.6667)
