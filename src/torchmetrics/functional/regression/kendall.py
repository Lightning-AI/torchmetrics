...
def kendall_rank_corrcoef(
    ...
    _variant: _MetricVariant = _MetricVariant.from_str(variant)
    _alternative: Optional[_TestAlternative] = _TestAlternative.from_str(alternative) if t_test else None
