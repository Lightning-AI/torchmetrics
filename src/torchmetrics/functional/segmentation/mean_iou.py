...
def total_intersect_and_union(preds,
                              target,
                              num_classes,
                              ignore_index,
                              label_map=dict(),
...
def _mean_iou_update(preds: Tensor,
                     target: Tensor,
                     num_labels: int,
                     ignore_index: bool,
                     nan_to_num: Optional[int] = None,
                     label_map: Optional[Dict[int, int]] = None,
                     reduce_labels: bool = False,) -> Tuple[Tensor, int]:
...
def mean_iou(preds: List[Tensor],
             target: List[Tensor],
             num_labels: int,
             ignore_index: bool,
             nan_to_num: Optional[int] = None,
             label_map: Optional[Dict[int, int]] = None,
             reduce_labels: bool = False,) -> Tensor:
    ...
    Example:
        ...
        tensor(0.2500)
    """
    total_area_intersect, total_area_union, total_area_pred_label, total_area_label = _mean_iou_update(preds, target, num_labels, ignore_index, nan_to_num, label_map, reduce_labels)
