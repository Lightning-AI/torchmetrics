...
def _permutation_invariant_training(
    ...
    raise DeprecationWarning(
        "Importing `permutation_invariant_training` from TM functional root was deprecated and will be removed in 2.0; "
...
def _pit_permutate(preds: Tensor, perm: Tensor) -> Tensor:
    raise DeprecationWarning(
        "Importing `pit_permutate` from TM functional root was deprecated and will be removed in 2.0;"
        " use importing from domain specific sub-package `torchmetrics.audio` instead."
    )
...
def _signal_distortion_ratio(
    ...
    raise DeprecationWarning(
        "Importing `signal_distortion_ratio` from TM functional root was deprecated and will be removed in 2.0;"
        " use importing from domain specific sub-package `torchmetrics.audio` instead."
    )
...
def _scale_invariant_signal_noise_ratio(preds: Tensor, target: Tensor) -> Tensor:
    raise DeprecationWarning(
        "Importing `scale_invariant_signal_noise_ratio` from TM functional root was deprecated"
...
def _signal_noise_ratio(preds: Tensor, target: Tensor, zero_mean: bool = False) -> Tensor:
    raise DeprecationWarning(
        "Importing `signal_noise_ratio` from TM functional root was deprecated and will be removed in 2.0;"
        " use importing from domain specific sub-package `torchmetrics.audio` instead."
    )
