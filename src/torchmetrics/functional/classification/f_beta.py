...
def binary_fbeta_score(
    ...
    """
    if validate_args:
        _binary_fbeta_score_arg_validation(beta, threshold, multidim_average, ignore_index, input_format=input_format)
...
def multiclass_fbeta_score(
    ...
    if validate_args:
        _multiclass_fbeta_score_arg_validation(
            beta, num_classes, top_k, average, multidim_average, ignore_index, input_format=input_format
        )
        _multiclass_stat_scores_tensor_validation(
...
def multilabel_fbeta_score(
    ...
    if validate_args:
        _multilabel_fbeta_score_arg_validation(
            beta, num_labels, threshold, average, multidim_average, ignore_index, input_format=input_format
        )
        _multilabel_stat_scores_tensor_validation(
...
def fbeta_score(
    ...
    if task == ClassificationTask.BINARY:
        return binary_fbeta_score(
            preds, target, beta, threshold, multidim_average, ignore_index, validate_args, input_format=input_format
        )
