...
def binary_specificity_at_sensitivity(
    ...
    sensitivity levels provided for binary tasks.
...
def multiclass_specificity_at_sensitivity(
    ...
    r"""Compute the higest possible specificity value given the minimum
    sensitivity level provided for multiclass tasks.
...
def multilabel_specificity_at_sensitivity(
    ...
    r"""Compute the higest possible specificity value given the minimum
    sensitivity level provided for multilabel tasks.
...
def specicity_at_sensitivity(
    ...
    r"""Compute the higest possible specicity value given the minimum
