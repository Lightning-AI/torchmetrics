...
def spectral_distortion_index(
    ...
    """Calculates `Spectral Distortion Index`_ (SpectralDistortionIndex_) also known as D_lambda that 
    is used to compare the spectral distortion between two images.
