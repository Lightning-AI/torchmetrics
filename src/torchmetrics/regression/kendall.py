...
class KendallRankCorrCoef(Metric):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.variant: _MetricVariant = _MetricVariant.from_str(variant)
        self.alternative: Optional[_TestAlternative] = _TestAlternative.from_str(alternative) if t_test else None
