...
class LPIPS(Metric):
    """The Learned Perceptual Image Patch Similarity (LPIPS) metric introduced in this
    `paper <https://arxiv.org/abs/1801.03924>`_ is used to judge the perceptual similarity between two images. LPIPS
