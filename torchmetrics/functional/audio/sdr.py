...
def sdr(
    ...
    .. note:: 2) preds and target need to have the same dtype, otherwise target will be converted to preds' dtype
    .. note:: 3) when pytorch<1.8.0, numpy will be used to calculate this metric, which causes ``sdr`` non-differentiable
