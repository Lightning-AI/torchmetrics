...
class StatScores(Metric):
    ...
    Accepts all inputs listed in :ref:`pages/details:input types`.
    ...
    Args:
        ...
        mdmc_reduce:
            ...
            - ``None`` [default]: Should be left unchanged if your data is not multi-dimensional
              multi-class (see :ref:`pages/details:input types` for the definition of input types).
        ...
        is_multiclass:
            ...
            :ref:`documentation section <pages/details:using the is_multiclass parameter>`
    ...
    def update(self, preds: torch.Tensor, target: torch.Tensor):
        """
        Update state with predictions and targets. See :ref:`pages/details:input types` for more information
        on input types.
