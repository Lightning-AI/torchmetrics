...
- Fixed `LearnedPerceptualImagePatchSimilarity` slowing down with every `forward` call for `reduction="mean"` and `reduction="sum"` ([#3514](https://github.com/Lightning-AI/torchmetrics/pull/3514))
