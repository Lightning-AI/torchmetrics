...
- Fixed a deadlock in `Metric._sync_dist` for `dist_reduce_fx=None` list states when ranks call `update()` a different number of times; this now raises an informative error instead ([#XXXX](https://github.com/Lightning-AI/torchmetrics/pull/XXXX))
